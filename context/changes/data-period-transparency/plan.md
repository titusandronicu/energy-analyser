...
- [x] 1.1 Unit tests for statusText and formatPeriod pass — eb29db9
- [x] 1.2 Lint passes — eb29db9
- [x] 1.3 Type check passes — eb29db9

#### Manual

- [x] 1.4 The glossary wording reads as plain Polish to the owner — eb29db9
