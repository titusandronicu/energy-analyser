...
5. Optional, independent of 4: join Micr.us to the tailnet as a tagged node, with an ACL limited to explicit ports on the home lab's main host. Verify that the app container cannot reach the tailnet.
